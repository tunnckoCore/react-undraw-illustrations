...
var UndrawBrowser = function UndrawBrowser(props) {
  return _react.default.createElement("svg", {
    ...
    width: "656.27",
    height: "26.69",
    transform: "rotate(-18.2 125.814 673.55)",
    fill: "#f5f5f5"
  }), _react.default.createElement("rect", {
    x: "256.92",
    y: "256.11",
    width: "656.27",
    height: "412.61",
    transform: "rotate(-18.02 194.198 883.26)",
    fill: "#fff"
    ...
    width: "210.37",
    height: "18.3",
    transform: "rotate(-18.07 -51.935 796.181)",
    ...
    width: "208.85",
    height: "15.25",
    transform: "rotate(-18.07 -52.176 795.466)",
    fill: props.primaryColor
  }), _react.default.createElement("rect", {
    x: "628.9",
    y: "239.13",
    width: "208.85",
    height: "15.25",
    transform: "rotate(-18.07 343.528 666.337)",
    fill: props.primaryColor
  }), _react.default.createElement("rect", {
    x: "628.9",
    y: "239.13",
    ...
    width: "9.15",
    height: "9.15",
    transform: "rotate(-18.07 -116.427 920.752)",
    fill: props.primaryColor,
    opacity: ".2"
  }), _react.default.createElement("rect", {
    x: "858.69",
    ...
    width: "9.15",
    height: "9.15",
    transform: "rotate(-18.07 473.476 728.234)",
    fill: props.primaryColor,
    opacity: ".5"
  }), _react.default.createElement("path", {
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 -6.283 884.78)",
    fill: props.primaryColor,
    opacity: ".5"
  }), _react.default.createElement("rect", {
    x: "362.26",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 19.684 964.576)",
    fill: props.primaryColor,
    opacity: ".8"
  }), _react.default.createElement("rect", {
    x: "485.45",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 142.877 924.393)",
    fill: props.primaryColor,
    opacity: ".7"
  }), _react.default.createElement("rect", {
    x: "608.63",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 266.075 884.178)",
    fill: props.primaryColor,
    opacity: ".5"
  }), _react.default.createElement("rect", {
    x: "731.82",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 389.273 843.964)",
    fill: props.primaryColor,
    opacity: ".2"
  }), _react.default.createElement("rect", {
    x: "388.21",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 45.65 1044.37)",
    fill: props.primaryColor,
    opacity: ".8"
  }), _react.default.createElement("rect", {
    x: "511.4",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 168.844 1004.188)",
    fill: props.primaryColor,
    opacity: ".7"
  }), _react.default.createElement("rect", {
    x: "634.58",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 292.042 963.973)",
    fill: props.primaryColor,
    opacity: ".5"
  }), _react.default.createElement("rect", {
    x: "757.77",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 415.24 923.759)",
    fill: props.primaryColor,
    opacity: ".2"
  }), _react.default.createElement("rect", {
    x: "459.5",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 116.91 844.598)",
    fill: props.primaryColor,
    opacity: ".2"
  }), _react.default.createElement("rect", {
    x: "582.68",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 240.108 804.383)",
    ...
    width: "94.51",
    height: "9.15",
    transform: "rotate(-18.07 363.338 764.174)",
    fill: props.primaryColor,
    opacity: ".2"
  }), _react.default.createElement("rect", {
    x: "291.69",
    ...
    width: "47.26",
    height: "47.29",
    transform: "rotate(-18.07 -74.544 995.34)",
    ...
    width: "47.26",
    height: "47.29",
    transform: "rotate(-18.07 -48.577 1075.135)",
    ...
    width: "259.15",
    height: "6.1",
    transform: "rotate(-18.2 -46.657 763.475)",
    fill: props.primaryColor,
    opacity: ".1"
  }), _react.default.createElement("path", {
    ...
    width: "7.62",
    height: "158.64",
    transform: "rotate(-18.07 499.894 848.787)",
    fill: props.primaryColor,
    opacity: ".1"
  }));
};

UndrawBrowser.propTypes = {
  /**
  * Hex color
  */
...
UndrawBrowser.defaultProps = {
  height: '100%',
  primaryColor: '#6c68fb',
  accentColor: '#43d1a0',
  class: ''
};
var _default = UndrawBrowser;
